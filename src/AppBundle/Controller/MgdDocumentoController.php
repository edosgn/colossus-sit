    ...
    public function responseAction(Request $request)
    {
        ...
        if ($authCheck == true) {
            ...
            if ($documento) {
                ...
                $documento->setFechaRespuesta(new \Datetime(date('Y-m-d h:i:s')));
        ...
        if ($authCheck == true) {
            ...
            if ($documento) {
                if ($params->correoCertificadoEnvio == 'true') {
                    $documento->setCorreoCertificadoEnvio($params->correoCertificadoEnvio);
                    $documento->setNombreTransportadoraEnvio($params->nombreTransportadoraEnvio);
                    $documento->setFechaEnvio(new \Datetime($params->fechaEnvio));

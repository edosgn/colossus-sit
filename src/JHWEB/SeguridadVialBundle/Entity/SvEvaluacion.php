 ...
 * SvEvaluacion
 *
 * @ORM\Table(name="sv_evaluacion")
 * @ORM\Entity(repositoryClass="JHWEB\SeguridadVialBundle\Repository\SvEvaluacionRepository")
 */
class SvEvaluacion
{
    /**
    ...
    /**
     * @ORM\OneToOne(targetEntity="SvRevision")
     */
    private $revision;

...
var NewTramiteEspecificoComponent = (function () {
    function NewTramiteEspecificoComponent(_TramiteService, _TramiteEspecificoService, _VarianteService, _CasoService, _TramiteGeneralService, _loginService, _route, _router) {
    ...
    NewTramiteEspecificoComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewTramiteEspecificoComponent.prototype.onSubmit = function () {
        var _this = this;
    ...
    NewTramiteEspecificoComponent = __decorate([
        core_1.Component({
            selector: 'register',
    ...
    ], NewTramiteEspecificoComponent);
    return NewTramiteEspecificoComponent;
}());
exports.NewTramiteEspecificoComponent = NewTramiteEspecificoComponent;
//# sourceMappingURL=new.tramiteEspecifico.component.js.map
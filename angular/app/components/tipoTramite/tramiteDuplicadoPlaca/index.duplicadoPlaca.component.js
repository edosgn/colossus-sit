...
var NewTramiteDuplicadoPlacaComponent = (function () {
    function NewTramiteDuplicadoPlacaComponent(_TramiteEspecificoService, _VarianteService, _CasoService, _loginService, _route, _router) {
    ...
    NewTramiteDuplicadoPlacaComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.tramiteEspecifico = new TramiteEspecifico_1.TramiteEspecifico(null, 16, this.tramiteGeneralId, null, null, null);
        var token = this._loginService.getToken();
        this._CasoService.showCasosTramite(token, 16).subscribe(function (response) {
        ...
        this._VarianteService.showVariantesTramite(token, 16).subscribe(function (response) {
    ...
    NewTramiteDuplicadoPlacaComponent.prototype.enviarTramite = function () {
        var _this = this;
        var token = this._loginService.getToken();
    ...
    NewTramiteDuplicadoPlacaComponent.prototype.onChangeCaso = function (event) {
        this.tramiteEspecifico.casoId = event;
    };
    NewTramiteDuplicadoPlacaComponent.prototype.onChangeVariante = function (event) {
        this.tramiteEspecifico.varianteId = event;
    };
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Object)
    ], NewTramiteDuplicadoPlacaComponent.prototype, "tramiteGeneralId", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], NewTramiteDuplicadoPlacaComponent.prototype, "tramiteCreado", void 0);
    NewTramiteDuplicadoPlacaComponent = __decorate([
        core_1.Component({
    ...
    return NewTramiteDuplicadoPlacaComponent;
}());
exports.NewTramiteDuplicadoPlacaComponent = NewTramiteDuplicadoPlacaComponent;
//# sourceMappingURL=index.duplicadoPlaca.component.js.map
...
var NewTramiteLevantarPrendaComponent = (function () {
    function NewTramiteLevantarPrendaComponent(_TramiteEspecificoService, _VarianteService, _CasoService, _VehiculoService, _loginService, _route, _router) {
        ...
        this.datos = {};
        this.levantarPignoracion = 1;
    }
    NewTramiteLevantarPrendaComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.tramiteEspecifico = new TramiteEspecifico_1.TramiteEspecifico(null, 45, this.tramiteGeneralId, null, null, null);
        var token = this._loginService.getToken();
        this._CasoService.showCasosTramite(token, 45).subscribe(function (response) {
        ...
        this._VarianteService.showVariantesTramite(token, 45).subscribe(function (response) {
    ...
    NewTramiteLevantarPrendaComponent.prototype.enviarTramite = function () {
        var _this = this;
        this.levantarPignoracion = 0;
        var token = this._loginService.getToken();
        ...
        this.vehiculo2 = new vehiculo_1.Vehiculo(this.vehiculo.id, this.vehiculo.clase.id, this.vehiculo.municipio.id, this.vehiculo.linea.id, this.vehiculo.servicio.id, this.vehiculo.color.id, this.vehiculo.combustible.id, this.vehiculo.carroceria.id, this.vehiculo.organismoTransito.id, this.vehiculo.placa, this.vehiculo.numeroFactura, this.vehiculo.fechaFactura, this.vehiculo.valor, this.vehiculo.numeroManifiesto, this.vehiculo.fechaManifiesto, this.vehiculo.cilindraje, this.vehiculo.modelo, this.vehiculo.motor, this.vehiculo.chasis, this.vehiculo.serie, this.vehiculo.vin, this.vehiculo.numeroPasajeros, this.levantarPignoracion, this.vehiculo.cancelado);
    ...
    NewTramiteLevantarPrendaComponent.prototype.onChangeCaso = function (event) {
        this.tramiteEspecifico.casoId = event;
    };
    NewTramiteLevantarPrendaComponent.prototype.onChangeVariante = function (event) {
        this.tramiteEspecifico.varianteId = event;
    };
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Object)
    ], NewTramiteLevantarPrendaComponent.prototype, "tramiteGeneralId", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Object)
    ], NewTramiteLevantarPrendaComponent.prototype, "vehiculo", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], NewTramiteLevantarPrendaComponent.prototype, "tramiteCreado", void 0);
    NewTramiteLevantarPrendaComponent = __decorate([
        core_1.Component({
            selector: 'tramiteLevantarPrenda',
            templateUrl: 'app/view/tipoTramite/levantarPrenda/index.html',
    ...
    return NewTramiteLevantarPrendaComponent;
}());
exports.NewTramiteLevantarPrendaComponent = NewTramiteLevantarPrendaComponent;
//# sourceMappingURL=index.levantarPrenda.component.js.map
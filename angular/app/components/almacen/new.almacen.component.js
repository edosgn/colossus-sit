...
var NewAlmacenComponent = (function () {
    function NewAlmacenComponent(_ClaseService, _ConsumibleService, _AlmacenService, _OrganismoTransitoService, _loginService, _ServicioService, _route, _router) {
    ...
    NewAlmacenComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewAlmacenComponent.prototype.onSubmit = function () {
        var _this = this;
        var token = this._loginService.getToken();
    ...
    NewAlmacenComponent = __decorate([
        core_1.Component({
            selector: 'register',
    ...
    return NewAlmacenComponent;
}());
exports.NewAlmacenComponent = NewAlmacenComponent;
//# sourceMappingURL=new.almacen.component.js.map
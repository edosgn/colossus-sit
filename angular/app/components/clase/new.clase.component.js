...
var NewClaseComponent = (function () {
    function NewClaseComponent(_ClaseService, _loginService, _route, _router) {
        this._ClaseService = _ClaseService;
        this._loginService = _loginService;
        this._route = _route;
        this._router = _router;
    }
    NewClaseComponent.prototype.ngOnInit = function () {
        this.clase = new clase_1.Clase(null, "", null);
    };
    NewClaseComponent.prototype.onSubmit = function () {
        var _this = this;
    ...
    return NewClaseComponent;
}());
exports.NewClaseComponent = NewClaseComponent;
//# sourceMappingURL=new.clase.component.js.map